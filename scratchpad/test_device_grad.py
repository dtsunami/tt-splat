...
cam = (torch.eye(3, dtype=torch.float64), torch.zeros(3, dtype=torch.float64), 40., 40., 16., 16., "t")
...
print(f"DEVICE_GRAD_TEST  worst_rel_err={worst:.3e}  -> {'OK' if worst < 5e-2 else 'FAIL'}")
